...
function GifRecorder(mediaStream, config) {
	 ...
	 * 
	 * @param {function}
	 *            callback - Callback function, that is used to pass recorded
	 *            blob back to the callee.
	 * @method
	 * @memberof GifRecorder
...
function MediaStreamRecorder(mediaStream, config) {
    ...
    function bufferToDataUrl(buffer, callback) {
        ...
        xhr.open('POST', '/videorecording/BlobServlet', true);
        ...
        xhr.onreadystatechange = function(){ {
        	if (xhr2.readyState == 4 && xhr2.status == 200) {
            	blob2 = new Blob([xhr2.response], {type: "video/webm"});
            }
        }
        
       /* xhr.onload = function(oEvent) {
        	  blob2 = new Blob([xhr.response], {type: "video/webm"});
        }*/	  
        xhr2.send();
        var reader = new FileReader();
