					...
					"ui.mouse",
					{
						...
						_mouseDown : function(a) {
							if (!d) {
								...
								var c = this, f = a.which == 1, g = typeof this.options.cancel == "string" ? b(
			...
			.widget(
					...
					d.ui.mouse,
					{
						...
						_create : function() {
							var b = this, a = this.options, c = this.element
									.find(".ui-slider-handle").addClass(
											"ui-state-default ui-corner-all"), f = a.values
									&& a.values.length || 1, e = [];
						...
						_refreshValue : function() {
							var b = this.options.range, a = this.options, c = this, f = !this._animateOff ? a.animate
									: false, e, j = {}, g, k, l, i;
							if (this.options.values
									&& this.options.values.length)
								this.handles
						...
						function() {
							if (!d.datepicker
									._isDisabledDatepicker(J.inline ? a
											.parent()[0] : J.input[0])) {
								d(this).parents(".ui-datepicker-calendar")
										.find("a")
					...
					M.prototype,
					{
						...
						_optionDatepicker : function(a, b, c) {
							...
							if (e) {
								...
								H(e.settings, f);
								if (i !== null && f.dateFormat !== B
										&& f.minDate === B)
									e.settings.minDate = this._formatDate(e, i);
								if (g !== null && f.dateFormat !== B
										&& f.maxDate === B)
						...
						_doKeyPress : function(a) {
							...
							if (d.datepicker._get(b, "constrainInput")) {
								b = d.datepicker._possibleChars(d.datepicker
										._get(b, "dateFormat"));
								var c = String
										.fromCharCode(a.charCode == B ? a.keyCode
												: a.charCode);
						...
						_get : function(a, b) {
							return a.settings[b] !== B ? a.settings[b]
									: this._defaults[b]
						},
						...
						_generateHTML : function(a) {
							...
							var s = this._get(a, "dayNamesMin"), A = this._get(
							...
							for (var E = this._getDefaultDate(a), w = "", x = 0; x < i[0]; x++) {
								for (var O = "", G = 0; G < i[1]; G++) {
									...
									var D = j ? '<th class="ui-datepicker-week-col">'
		...
		|| function(f, j) {
			...
			f.effects.animateClass = function(c, a, b, d) {
				...
				return this.queue(function() {
					var e = f(this), g = e.attr("style") || " ", h = p(o
							.call(this)), r, v = e.attr("class");
