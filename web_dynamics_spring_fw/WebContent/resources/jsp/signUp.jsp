...
<link rel="stylesheet" href="../css/style.css" type="text/css"
	media="screen" />
<link rel="stylesheet" href="../css/social-icons.css" type="text/css"
	media="screen" />
<!--[if IE 8]>
...
<link rel="stylesheet" href="../css/nivo-slider.css" type="text/css"
	media="screen" />
<script src="../js/nivo-slider/jquery.nivo.slider.js"
...
<script type="text/javascript"
	src="../js/superfish-1.4.8/js/hoverIntent.js"></script>
<script type="text/javascript"
	src="../js/superfish-1.4.8/js/superfish.js"></script>
<script type="text/javascript"
	src="../js/superfish-1.4.8/js/supersubs.js"></script>
<!-- ENDS superfish -->

<!-- poshytip -->
<link rel="stylesheet"
	href="../js/poshytip-1.0/src/tip-twitter/tip-twitter.css"
	type="text/css" />
<link rel="stylesheet"
	href="../js/poshytip-1.0/src/tip-yellowsimple/tip-yellowsimple.css"
	type="text/css" />
<script type="text/javascript"
	src="../js/poshytip-1.0/src/jquery.poshytip.min.js"></script>
<!-- ENDS poshytip -->
...
<body class="home">
	...
	<div id="main">
		...
		<div class="wrapper">
			...
			<div class="clear"></div>
			<div id="headline">
				<span class="main">welcome to our signup section fill form to register</span>
				<form action="signupservlet" method="post" id="loginform">				
				<table>
					<tbody>
						<tr>
						<td>
					    ...
					    <td>
						   <input type="text" name="emailid" title="EmailId"
											value="EmailId..." id="emailId" />
						</td>
						</tr>
					    ...
					    <td>
						   <input type="password" name="passwd" title="Password"
											 id="password" />
						</td>
						</tr>
					    ...
					    <td>
						   <input type="password" name="passwdrepeat" title="RepeatPassword"
											id="repeatpasswd" />
						</td>
						</tr>
	...
	<div id="twitter">
		<div class="wrapper">
			<a href="#" id="prev-tweet"></a> <a href="#" id="next-tweet"></a> <img
				id="bird" src="../img/twitterbird.jpeg" alt="Tweets" />
			<div id="tweets">
