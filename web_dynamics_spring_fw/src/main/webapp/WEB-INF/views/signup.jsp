...
<title>signup-web</title>
<!--  ======================================================================= -->

<!-- CSS -->
<link rel="stylesheet" href="resources/css/style.css" type="text/css"
	media="screen" />
<link rel="stylesheet" href="resources/css/social-icons.css" type="text/css"
	media="screen" />
<!--[if IE 8]>
			<link rel="stylesheet" type="text/css" media="screen" href="resources/css/ie8-hacks.css" />
		<![endif]-->
<!-- ENDS CSS -->
...
<script type="text/javascript"
	src="resources/js/jquery-ui-1.8.13.custom.min.js"></script>
...
<link rel="stylesheet" href="resources/css/nivo-slider.css" type="text/css"
	media="screen" />
<script src="resources/js/nivo-slider/jquery.nivo.slider.js"
...
<!-- prettyPhoto -->
<script type="text/javascript"
	src="resources/js/prettyPhoto/js/jquery.prettyPhoto.js"></script>
<link rel="stylesheet" href="resources/js/prettyPhoto/css/prettyPhoto.css"
...
<script type="text/javascript"
	src="resources/js/superfish-1.4.8/js/hoverIntent.js"></script>
<script type="text/javascript"
	src="resources/js/superfish-1.4.8/js/superfish.js"></script>
<script type="text/javascript"
	src="resources/js/superfish-1.4.8/js/supersubs.js"></script>
<!-- ENDS superfish -->

<!-- poshytip -->
<link rel="stylesheet"
	href="resources/js/poshytip-1.0/src/tip-twitter/tip-twitter.css"
	type="text/css" />
<link rel="stylesheet"
	href="resources/js/poshytip-1.0/src/tip-yellowsimple/tip-yellowsimple.css"
	type="text/css" />
<script type="text/javascript"
	src="resources/js/poshytip-1.0/src/jquery.poshytip.min.js"></script>
<!-- ENDS poshytip -->
...
<!-- Fancybox -->
<link rel="stylesheet"
	href="resources/js/jquery.fancybox-1.3.4/fancybox/jquery.fancybox-1.3.4.css"
	type="text/css" media="screen" />
<script type="text/javascript"
	src="resources/js/jquery.fancybox-1.3.4/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
<!-- ENDS Fancybox -->
...
<body class="home">
				...
				<form action="./processlogin" method="post" id="loginform">
					<table>
						<tbody>
							...
							<tr>
							<td colspan="3">
							<a href="./signUp.jsp">new user ? Need an Account</a>	
							</td>
		...
		<div id="menu-holder">
			...
			<div class="wrapper">
				...
				<ul id="nav" class="sf-menu">
					<li class="current-menu-item"><a href="./index.jsp">Home<span
							class="subheader">Welcome</span></a></li>
					<li><a href="./features.jsp">Features<span
						...
						<ul>
							...
							<li><a href="features-infobox.jsp"><span> Text
										box</span></a></li>
							<li><a href="features-monobox.jsp"><span> Icons</span></a></li>
						</ul></li>
					<li><a href="./blog.jsp">Blog<span class="subheader">Read
								our posts</span></a></li>
					<li><a href="./portfolio.jsp">Portfolio <span
							class="subheader">Showcase work</span></a></li>
					<li><a href="./gallery.jsp">Gallery<span class="subheader">Featured
								work</span></a>
						<ul>
							<li><a href="./gallery.jsp"><span> Four columns</span></a></li>
							<li><a href="gallery-3.jsp"><span> Three columns
								</span></a></li>
							<li><a href="gallery-2.jsp"><span> Two columns </span></a></li>
							<li><a href="video-./gallery.jsp"><span> Video
										gallery </span></a></li>
						</ul></li>
					<li><a href="./contact.jsp">Contact<span class="subheader">Get
								in touch</span></a></li>
				</ul>
				<!-- Navigation -->
			</div>
	...
	<div id="slider-block">
		<div id="slider-holder">
			<div id="slider">
				<a href="http://www.luiszuno.com"><img src="resources/images/03.jpg"
					title="my page background 3!"
					alt="" /></a> <a
					href="http://facebook.com"><img
					src="resources/images/04.jpg"
					title="mypage background 4"
					alt="" /></a>
			</div>
		</div>
	</div>
				...
				<div class="panes">
					...
					<div>
						<ul class="blocks-thumbs thumbs-rollover">
							<li><a href="single.jsp" class="thumb" title="An image"><img
									src="resources/img/dummies/282x150.gif" alt="Post" /></a>
								<div class="excerpt">
								...
								</div> <a href="single.jsp" class="link-button"><span>Read
										more &#8594;</span></a></li>
							<li><a href="single.jsp" class="thumb" title="An image"><img
									src="resources/img/dummies/282x150.gif" alt="Post" /></a>
								<div class="excerpt">
					...
					<div>
						<div class="plain-text">
							...
							<p>
								...
								feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu
								libero sit amet quam egestas semper <a href="single.jsp">This
							...
							<a href="single.jsp" class="link-button"><span>Read
									more &#8594;</span></a>
						</div>
					</div>
					<!-- ENDS Information -->
	...
	<div id="twitter">
		<div class="wrapper">
			<a href="#" id="prev-tweet"></a> <a href="#" id="next-tweet"></a> <img
				id="bird" src="resources/img/twitterbird.jpeg" alt="Tweets" />
			<div id="tweets">
